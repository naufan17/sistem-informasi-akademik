                        ...
                        <div class="flex-none md:w-1/5">
                            <div class="relative">
                                ...
                                <select type="text" name="status" value="" class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-state">
                                    <option value="">Awaliyah</option>
                                    <option value="">1 Wustho</option>
                                    <option value="">2 Wustho</option>
                                    <option value="">1 Ulya</option>
                    ...
                    <table class="table-auto bg-white">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                ...
                                <th class="text-left w-1/3 py-3 px-4 uppercase font-semibold text-sm">Kelas</th>
