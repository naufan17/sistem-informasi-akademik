    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <!-- BACK BUTTON -->
                <div class="p-4">
                    <a href="{{ url('santri/data-diri') }}/{{ Auth::user()->id }}" class="button flex items-center border border-teal-500 text-teal-500 rounded-sm py-3 px-6 w-36 hover:bg-blue-700 hover:text-white">
