                ...
                <form method="GET" action="{{ url('santri/data-diri-update') }}">
                    ...
                    <div>
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-4 space-y-1">
                            ...
                            <div class="relative z-0 w-full">
                                <input type="text" name="status" placeholder=" " value="{{ $user->status }}" required class="self-center w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            </div>
                        </div>
