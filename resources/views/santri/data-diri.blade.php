        ...
        <main class="w-full flex-grow-0 pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <div class="flex object-left text-center text-white text-base p-4">
                    <a href="{{ url('santri/data-diri/form-update') }}" class="button bg-blue-600 hover:bg-blue-800 sm:text-base text-sm hover:text-white hover:no-underline rounded shadow-lg py-2.5 px-6">Perbarui</a>
                </div>
