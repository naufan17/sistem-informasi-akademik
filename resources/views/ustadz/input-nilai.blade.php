                    ...
                    <table class="table-auto bg-white">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                ...
                                <th class="text-left w-1/6 py-3 px-4 uppercase font-semibold text-sm">Tugas</th>
                                <th class="text-left w-1/6 py-3 px-4 uppercase font-semibold text-sm">Keaktifan</th>
                                <th class="text-left w-1/6 py-3 px-4 uppercase font-semibold text-sm">Imtihan</th>
                    ...
                    <div class="w-full mx-auto flex flex-wrap">
                        <div class="text-left flex w-full lg:w-1/2 ">
                            <div class="px-3 md:px-0">
                                ...
                                <a class="inline-block no-underline hover:text-black hover:underline" href="https://web.whatsapp.com/send?phone=6285725655593&text=Assalamualaikum%20Admin">WhatsApp.
                                    0857 2565 5593</a><br>
