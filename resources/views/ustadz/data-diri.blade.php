    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <div class="flex object-left text-center text-white sm:text-base text-sm p-4">
                    <a href="{{ url('ustadz/data-diri/form-update') }}" class="button bg-blue-600 hover:bg-blue-800 hover:text-white hover:no-underline rounded shadow-lg py-2.5 sm:px-6 px-3.5">Perbarui</a>
                </div>
