    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <form method="POST" action="{{ url('ustadz/kelas') }}">
                    @csrf
                    <div class="flex space-x-4 items-center pb-8">
                        ...
                        <div class="flex-none md:w-1/5">
                            <div class="relative">
                                ...
                                <input type="hidden" name="id_santri" placeholder="" value="{{ Auth::user()->id }}" required autocomplete="name" required class="py-2 px-3 block w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-300" />
                ...
                <form method="POST" action="{{ url('ustadz/kelas/cetak') }}">
                    ...
                    <div class="flex space-x-4 items-center pb-8">
                        ...
                        <input type="hidden" name="semester" placeholder=" " value="{{ $semester }}" required class="self-center w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    </div>
                    <div class="flex space-x-4 items-center pb-8">
                        <div class="object-left text-center text-white text-base">
