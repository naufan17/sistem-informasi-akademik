...
Route::group(['middleware' => 'auth:santri'], function () {
    ...
    Route::post('/santri/kelas/delete', [KelasSantriController::class, 'delete'])->name('santri.kelas.delete');
...
Route::group(['middleware' => 'auth:ustadz'], function () {
    ...
    Route::post('/ustadz/kelas/detail-santri/create', [KelasUstadzController::class, 'createNilai'])->name('ustadz.kelas.detail-santri.create');
